...
public class ConstantRead {
    ...
    public static void main(String[] args) {
        try {
            ...
            String rec = (String) msg.sendMessage(reader, info);
            ...
            String response1 = (String) msg.sendMessage(reader, Workflow);
            System.out.println("Response: " + response1);
            
            // Start BulkTagRead
            String Startread = ejsonp.formJSONCommand(ECTConstants.START_RZ);
            System.out.println("Command: " + Startread);
            String response2 = (String) msg.sendMessage(reader, Startread);
            ...
            do {
                Thread.sleep(1000);
                String data = (String) msg.receiveMessage(reader.getInputStream());
                if (!data.equals(""))
            ...
            String response3 = (String) msg.sendMessage(reader, Stopread);
